...
- **Аутентификация обязательна.** Без `API_KEY` сервис отклоняет все запросы - открытого режима больше нет. API слушает на `0.0.0.0`; при доступе извне используйте TLS-прокси или ограничьте порт фаерволом.
